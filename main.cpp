...
void draw1()
{
   ...
   float a,b,c,d,l ,z=0,i,x;
     float  x1,x2;
  cout<<width;
            for(x=-3500;x<3500;x=x+1){
                    a=x;
x1=((float)x/SIZE);
x2=(((float)(x+1))/SIZE);
//cout<<x1;
           ...
           b=ParserResult(UserEqun,x1,z)*37;
            d=ParserResult(UserEqun,x2,z)*37;
 x1=x1*37;
 x2=x2*37;
  ...
  drawline(x1+460, b+350, x2+460, d+350);
     }
}
void drawline(float x1, float y1, float x2, float y2)
{
...
int main(int argc ,char**argv){
    char am;
    float y,a=0.0 ,w,z[700],x1,y1,x2,y2;
    int x;
    char ne[250];
     ...
     cout<<"Enter 3 for 3d graph or 2 for 2d graph"<<endl;
     cout<<"Enter number:";
     cin>>c;
	...
	if(c==3){
	     ...
	     window(width,height,100,00,"GRAPH 2D");
	}
